...
```{r}
MyMap <- WorldMap + 
  geom_point(aes(x=Long, y=Lat), data = EMCRlocationdata, colour = "#CF6B21", size =10, alpha=0.8, shape=17) +
  ylim(-65,90) +
...
```{r}
AusMap <- WorldMap + 
  geom_point(aes(x=Long, y=Lat), data = EMCRlocationdata, colour = "#CF6B21", size =14, alpha=0.7, shape=17) +
  ylim(-45,-11) +
  xlim(110, 155) +
  theme(axis.text=element_text(size=40),
        axis.title=element_text(size=55)) +
